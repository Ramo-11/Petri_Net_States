...
3- A manual input of matrix L which defines the desired controlling behaviour
...
Notes on compiling:
The program must be compiled using C++11 or any new version, the makefile already ensures that. Otherwise, it will copmlain about 2D vector notations.